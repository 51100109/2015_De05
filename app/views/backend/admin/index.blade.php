        ...
        <div class="container-fluid">
          ...
          @if(Auth::check())
           ...
           <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" role="button" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> {{ Auth::user()->creenname }}<b class="caret"></b></a>
                <ul class="dropdown-menu" role="menu">
