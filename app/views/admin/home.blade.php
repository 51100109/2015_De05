            ...
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{asset('admin/admin-activities')}}" class="block"> Xem thêm <span class="glyphicon glyphicon-arrow-right"></span></a>
                        </div>
                    </div>
                    @else
                        <div class="panel-body">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="text-right">
                        <a href="{{asset('admin/user-activities')}}" class="block"> Xem thêm <span class="glyphicon glyphicon-arrow-right"></span></a>
                        </div>
                    </div>
                    @else
                        <div class="panel-body">
